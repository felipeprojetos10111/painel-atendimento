...
export default function PainelPage() {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      {/* Topbar */}
      <header className="flex items-center justify-between px-6 py-3 bg-[#0f1117] text-white shadow-md z-10">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 text-sm px-3 py-1.5 rounded-lg transition-colors border ${
              mostrarMetricas && !conversaSelecionada
                ...
                : 'border-[#2d3748] text-[#8b949e] hover:bg-[#1c2333]'
            }`}
          >
          ...
          {nomeCliente && (
            <span className="text-[#8b949e] text-sm font-normal border-l border-[#2d3748] pl-3 ml-1">
              {nomeCliente}
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-sm bg-[#1c2333] hover:bg-[#212840] px-4 py-1.5 rounded-lg transition-colors flex items-center gap-1.5"
          ...
          {impersonandoOperador && (
            <button
              ...
              className="text-sm bg-green-500 text-white font-semibold px-4 py-1.5 rounded-lg transition-colors hover:bg-green-600 flex items-center gap-1.5"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={logout}
            className="text-sm bg-[#1c2333] hover:bg-[#212840] px-4 py-1.5 rounded-lg transition-colors"
          >
            {tr('sair')}
          </button>
        </div>
